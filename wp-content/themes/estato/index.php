...
if ( have_posts() ) {
	...
	if ( is_search() ) { ?>
		<article class="btNoSearchResults boldSection gutter bottomSemiSpaced topSemiSpaced ">
			<div class="port">
			<?php echo boldthemes_get_heading_html( '', esc_html__( 'We are sorry, no results for: ', 'estato' ) . get_query_var( 's' ), "<a href='" . site_url() . "'>" . esc_html__( 'Back to homepage', 'estato' )."</a>", 'medium', '', '', '' ) ?>
			</div>
		</article>
	<?php }
}
